  ...
  export interface Typegen0 {
        '@@xstate/typegen': true;
        internalEvents: {
          "xstate.after(100)#timer.clock.running": { type: "xstate.after(100)#timer.clock.running" };
...
"updateTimerFromInput": "UPDATE";
        ...
        matchesStates: "clock" | "clock.idle" | "clock.paused" | "clock.running" | "view" | "view.collapsed" | "view.open" | { "clock"?: "idle" | "paused" | "running";
"view"?: "collapsed" | "open"; };
        tags: never;
      }
